...
//        Button button = (Button) findViewById(R.id.cont);
    ...
    class loginAccess extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... strArr) {
            ...
            try {
                makeHttpRequest = makepay.this.jsonParser.makeHttpRequest((com.ecomflexi.softwarelabbd.makepay.getPref(ImagesContract.URL, makepay.this.getApplicationContext()) + "/apiapp/") + "makepay", HttpPost.METHOD_NAME, arrayList);
            } catch (IOException e) {
