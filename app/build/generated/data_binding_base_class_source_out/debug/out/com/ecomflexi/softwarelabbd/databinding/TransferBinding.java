...
public final class TransferBinding implements ViewBinding {
  ...
  private TransferBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText amount,
      ...
      @NonNull TextInputEditText pin, @NonNull ScrollView scrollview, @NonNull Button sub,
  ...
  public static TransferBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TransferBinding((LinearLayout) rootView, amount, bal, band, bank, cba, drive, hm,
          main, mainlayout, msg, pin, scrollview, sub, txtPassword, uitop, username);
    }
