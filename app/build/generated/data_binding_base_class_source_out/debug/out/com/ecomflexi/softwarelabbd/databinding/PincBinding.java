...
public final class PincBinding implements ViewBinding {
  ...
  private PincBinding(@NonNull LinearLayout rootView, @NonNull TextView band, @NonNull TextView cba,
      @NonNull TextInputEditText conpass, @NonNull CircleImageView hm,
  ...
  public static PincBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PincBinding((LinearLayout) rootView, band, cba, conpass, hm, mainlayout, newpass,
          oldpass, reg, scrollview, txtPassword, uitop);
    }
