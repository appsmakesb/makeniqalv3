...
public final class BanktransferBinding implements ViewBinding {
  ...
  private BanktransferBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText amount,
  ...
  public static BanktransferBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BanktransferBinding((LinearLayout) rootView, amount, band, branch, cba, flot, hm,
